...
|                                        | **Need Improvement**                                         | **Satisfactory**                                             | **Good**                                                     | **Excellent**                                                |
| -------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| *Presentation (Group) (10 marks)* | <ul><li>No coordination among members</li><li>Incoherent presentation flow</li></ul><br/>(< 3 marks) | <ul><li>Some coordination among members</li><li>Presentation flow is evident</li></ul><br/> ( < 5 marks) | <ul><li>Good coordination among members</li><li>Presentation flow is good and task division is good</li></ul><br/> (< 8 marks) | <ul><li>Excellent coordination among members</li><li>Very good presentation flow and very clear task division.</li></ul><br/>( <= 10 marks) |
| *Presentation (Individual) (20 marks)* | <ul><li>Unable to present the content or incoherent presentation</li><li>Unable to answer most of the questions</li></ul><br/>(< 8 marks) | <ul><li>Somewhat clear and coherent presentation</li><li>Able to answer some questions </li></ul><br/>(< 12 marks) | <ul><li>Mostly clear and coherent presentation with some demo of deployment / application </li><li>Able to answer most of the questions</li><br/>(< 16 marks) | <ul><li>Very clear and coherent presentation with demo of application / deployment</li><li>Able to answer all or most of the questions confidently</li><br/>( <= 20 marks) |
...
|15|  | **26-Jul-22**<br/> Project Dev / Consultation <br/> (WCH-KLR) ||
|16|  | **2-Aug-22**<br/> Project Dev / Consultation <br/> (WCH-KLR) ||
|17|  | **10-Aug-22**<br/> Project Dev/ Consultation - **Milestone Submission** <br/> (MKK-VER) ||
|18|**14-Aug-22**<br/> Project Dev / Consultation <br/> (LCY-VER)|**16-Aug-21**<br/> Project Dev / Consultation <br/> (BRO-VER)|**17-Aug-22**<br/> Project Dev / Consultation <br/> (BRO-ZZQ)|
